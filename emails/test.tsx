      ...
      >
        ...
        >
          ...
          <Text style={{ color: "black" }}>
            <Heading style={{ fontSize: "18px" }}>Salam</Heading>
            {renderContent()}
          </Text>
          ...
          >
            This is an automated email, any inquiries should be directed to
            msa@wlu.ca. To unsubscribe from these emails, click{" "}
