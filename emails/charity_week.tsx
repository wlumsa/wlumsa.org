    ...
    <Body style={main}>
      <Container style={container}>
        <Container style={logoContainer}>
          <Row>
            <Column>
              <Img
                src={
                  "https://qxhgmdhdnavuvrexvjhw.supabase.co/storage/v1/object/public/wlumsa_storage_bucket_test/MSA%20Logo-2.png"
                } // url || ""
                width="50"
                height="50"
                alt="logo"
            ...
            <Column>
              <Img
                src={
                  "https://mrucujpvbprmpznsgmfr.supabase.co/storage/v1/object/public/msa_public/media/Laurier_IRC_logo.png"
                }
                width="50"
                height="50"
                alt="logo"
            ...
            <Column>
              <Img
                src={
                  "https://mrucujpvbprmpznsgmfr.supabase.co/storage/v1/object/public/msa_public/media/Blue%20-%20image.png"
                }
                width="40"
                height="40"
                alt="logo"
        ...
        <Section style={CTAbuttonContainer}>
          <Button
            style={CTAbutton}
            href="https://www.launchgood.com/v4/campaign/wilfrid_laurier_msa__cw_2024"
          >
            Donate here
          </Button>
        </Section>
