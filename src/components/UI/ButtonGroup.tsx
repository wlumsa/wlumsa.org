...
export const ButtonGroup:React.FC<ButtonGroupProps> = ({categories}) => {
  ...
  return (
     <div>
        <div className="text-center navbar justify-center">
            <div className="navbar-start flex justify-center w-full">
                <div className="dropdown">
                    <div tabIndex={0}  className=" flex flex- lg:hidden text-primary font-semibold bg-secondary p-2 rounded">
                        
                    <button className="flex items-center space-x-2">
                    <span>{selectBtn ? selectBtn.title : 'Select a category'}</span>
