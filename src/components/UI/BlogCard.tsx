  ...
  return (
    ...
    <article className="h-full">
      ...
      <div className="relative aspect-[16/10] w-full overflow-hidden bg-base-200">
        {image?.url ? (
          ...
          <div className="flex h-full w-full items-center justify-center" aria-hidden>
            <span className="font-heading text-5xl font-bold text-primary/10">MSA</span>
          </div>
        )}
      </div>
      ...
      <div className="flex flex-1 flex-col p-4 sm:p-5">
        ...
        <h3 className="mb-3 text-balance font-heading text-xl font-bold leading-tight text-base-content underline decoration-transparent underline-offset-4 transition-colors group-hover:text-primary group-hover:decoration-primary/35 sm:text-[1.45rem]">
          {post.title}
        </h3>
