...
const Footer: React.FC = () => {
    ...
    useEffect(() => {
        const fetchFooterItems = async (collectionName: string, setState: React.Dispatch<React.SetStateAction<FooterItem[]>>) => {
        const collectionRef = collection(db, collectionName);
        const querySnapshot = await getDocs(collectionRef);
        
        const itemsData = querySnapshot.docs.map(doc => doc.data() as FooterItem);
        setState(itemsData);
        };
