...
> = ({ name,first_name, first_name_placeholder, last_name, last_name_placeholder, studentID, studentID_placeholder, email, email_placeholder, errors, label, register, required: requiredFromProps, width, }) => {
  ...
  return (
    ...
    <div className='items-center justify-center'>
      ...
      <div className="flex flex-row text-gray-600 gap-8">
       ...
       <div className='flex flex-col py-2 '>
        <label className="label  text-lg" htmlFor="first_name">
            ...
            id={first_name}
            //    {...register("first_name", { required: requiredFromProps })}
            />
       </div>
            <div className='flex flex-col py-2'>
                ...
                id={last_name}
                //  {...register(last_name, { required: requiredFromProps })}
                />
      ...
      <div className='flex flex-col py-2'>
            ...
            id={studentID}
            //    {...register(studentID, { required: requiredFromProps })}
            />
        </div>
        <div className='flex flex-col py-2'>
            ...
            id={email}
            // {...register(email, { required: requiredFromProps })}
            />
        </div>
      </div>
    </div>
