        ...
        if (name === "amenitiesOptions") {
            return {
                ...
                selectedAmenities: checked
                    ...
                    : (prevData.selectedAmenities || []).filter((item) => item !== value) 
            };
        } else if (name === "utilitiesOptions") {
            return {
                ...prevData,
                selectedUtilities: checked
                    ? [...(prevData.selectedUtilities || []), value]
                    : (prevData.selectedUtilities || []).filter((item) => item !== value) 
            };
        }
        return prevData;
    });
            ...
            {currentStep == 1 && <div>
                ...
                {currentStep == 2 && <div className='flex flex-col gap-4'>
                    ...
                    <div className='flex flex-col md:flex-row gap-4'>
                        ...
                        <div className='flex flex-col md:w-1/2'>
                            <input type="tel" name="phone" value={formData.phone} onChange={handleInputChange} placeholder="Phone number" className="input input-bordered  max-w-xs  h-[2rem] w-full bg-[#F2F2F2] border-none" />
                        </div>
                    </div>
                    <div>
