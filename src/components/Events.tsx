        ...
        <>
            <div className="hero h-fit bg-base-100">
                <div className="hero-content flex-col lg:flex-row">
                    <img src="https://northdallasgazette.com/wp-content/uploads/2019/09/WhatsApp-Image-2019-09-15-at-9.08.28-PM-1024x641.jpeg" className="max-w-sm rounded-lg shadow-2xl" />
                    <div className="px-12 max-w-md lg:max-w-xl">
            ...
            <div className="hero h-fit bg-base-100">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <img src="https://iqna.ir/files/en/news/2018/5/10/28671_904.jpg" className="max-w-sm rounded-lg shadow-2xl" />
                    <div className="px-12 max-w-md lg:max-w-xl">
