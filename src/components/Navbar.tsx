    ...
    return (
        <div className="navbar bg-primary fixed top-0 z-30 rounded-b-3xl">
            ...
            <div className="navbar-end">
                <a href="https://docs.google.com/document/d/1OOn5P8qV7D8u0Gv59DLhAq8jBkMRxLkSQPPwuc3IMN0/edit?usp=sharing" target='_blank' rel='noopener noreferrer' className="btn btn-ghost text-secondary">Donate</a>
            </div>
        </div>
    );
}
