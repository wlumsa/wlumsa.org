        ...
        <div className="dropdown">
          ...
          >
            {navbarData.items.map((item, index) => {
              return (
                <li key={index} className="hover:scale-105 hover:text-secondary">
        ...
        <ul className="menu menu-horizontal gap-2 px-2" tabIndex={0}>
          {navbarData.items.map((item, index) => {
            return (
              ...
              >
                {item.links && item.links.length === 1 ? (
                  <li className="hover:scale-105 hover:text-secondary">
                    <Link
                      className="min-w-0 flex-shrink"
                      href={item.links[0]?.url || "#"}
                    >
                  ...
                  <li className="dropdown dropdown-hover hover:scale-105 hover:text-secondary">
                    <div>{item.label}</div>
