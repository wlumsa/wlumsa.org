...
import { updateDoc, doc, increment, collection, addDoc} from "firebase/firestore";
...
interface Product {
  ...
  const BuyForm: React.FC<BuyFormProps> = ({ products, totalPrice }) => {
    ...
    const handlePickupTimeChange = (event: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    return (
        <div>
            ...
            <div className="flex items-center">
                <div className="w-full md:w-[30rem] px-2  rounded-xl">
                    ...
                    <form className="card-body" onSubmit={handleSubmit}>
                        ...
                        <div className="flex flex-col gap-2 ">
                            ...
                            <label className="form-control w-full max-w-xs">
                                ...
                                <input type="file" className="file-input-s file-input-bordered w-full max-w-xs" accept="image/*" onChange={handleImageUpload}/>
