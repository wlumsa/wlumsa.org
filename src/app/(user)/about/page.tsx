...
export default async function About() {
  ...
  return (
    <div>
      <div className="flex-grow px-4 sm:px-10 mt-20">
        <div className="flex flex-col items-center justify-center">
          {/* About Us Section */}
          <div className="hero h-fit self-center">
            <div className="w-full max-w-4xl hero-content flex flex-col items-center justify-center gap-8">
              ...
              <div className="flex flex-col items-center justify-center gap-8 md:flex-row md:items-start">
                <Image
                  src={logo}
                  className="h-48 w-48 rounded-lg shadow-2xl"
                  alt="MSA Logo"
                />
                <p className="py-6 text-lg text-neutral text-center md:text-left max-w-md">
                  The <strong>Laurier Muslim Student Association (MSA)</strong> is
                  a student-run organization at Laurier which was founded in 2010.
                  Its primary purpose is to provide a platform for Muslim students
                  to come together, practice their faith, engage in community
          ...
          {/* Services Offered Section */}
          <div className="flex-1 py-10 w-full" id="services">
            <h2 className="mb-4 text-center text-4xl font-bold text-primary">
              Services Offered
            </h2>
            <div className="mb-10 flex flex-wrap items-center justify-center gap-4">
                ...
                servicesInfo.map((service: Service, index: number) => (
                  ...
                  >
                    <div className="card-body">
                      ...
                      <p className="text-neutral">{service.description}</p>
                      {/* Uncomment when service links are ready */}
                      {/* {service.link && (
                        <div className="card-actions justify-end">
                          <a
          ...
          <div
            className="mb-10 flex w-full flex-col py-10 md:w-3/4 items-center"
            id="constitution"
          >
            <h2 className="mb-4 text-center text-4xl font-bold text-primary">
              Constitution
            ...
            <Link
              ...
              className="mt-4"
            >
              <button className="btn btn-primary border-0 text-secondary shadow duration-200 hover:scale-105 hover:bg-secondary hover:text-primary">
                View on Google Docs
              </button>
            </Link>
          </div>
