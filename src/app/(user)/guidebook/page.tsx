      ...
      <section className="mx-auto mb-10 max-w-6xl px-4 sm:px-6">
        <div className="flex flex-col items-center gap-8 lg:flex-row lg:items-start lg:gap-10">
          <div className="max-w-2xl flex-1 text-center lg:text-left">
            <h1 className="font-heading mb-4 text-balance text-4xl font-bold text-primary md:text-5xl">
              MSA Resource Guide
            </h1>

            <div className="font-body mb-5 space-y-4 text-base-content/80">
              ...
              <ul className="grid gap-2.5 text-left text-[15px] leading-relaxed md:grid-cols-2">
                <li className="rounded-md border border-base-300 bg-gradient-to-b from-base-100 to-base-200/40 px-3 py-2 shadow-[0_1px_2px_rgba(0,0,0,0.06),0_8px_20px_rgba(0,0,0,0.05)]">
                ...
                <li className="rounded-md border border-base-300 bg-gradient-to-b from-base-100 to-base-200/40 px-3 py-2 shadow-[0_1px_2px_rgba(0,0,0,0.06),0_8px_20px_rgba(0,0,0,0.05)]">
                  How to stay in the loop on events
                </li>
                <li className="rounded-md border border-base-300 bg-gradient-to-b from-base-100 to-base-200/40 px-3 py-2 shadow-[0_1px_2px_rgba(0,0,0,0.06),0_8px_20px_rgba(0,0,0,0.05)]">
                  Accommodation tips for Muslim students
                </li>
              </ul>
            </div>

            <p className="font-body max-w-xl text-base leading-relaxed text-base-content/75 md:text-lg">
              We put everything in one simple guide so you can settle in faster.
            </p>
            <p className="mt-3 max-w-xl text-sm text-base-content/70">
              Sign up below and we&apos;ll email you the MSA Resource Guide
              instantly.
            </p>
          </div>
          ...
          <div className="flex-shrink-0">
            <Image
              ...
              alt={
                mediaDocs[0]?.alt ||
                "MSA Resource Guide cover showing campus resources and Islamic accommodations"
              }
