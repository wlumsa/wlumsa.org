...
export default async function RamadanPage(props: { params: Params }) {
      ...
      <main className="flex-grow">
        <div className="flex w-full flex-col items-center">
          ...
          <div className="mx-4 flex flex-col items-center">
            <h1 className="mb-10 mt-32 text-xl font-bold text-[#203B5D] md:text-3xl">
              DONATE THIS RAMADAN
            </h1>
            <p className=" text-center">
              Contribute to our notable goal of raising $25000 for the Gaza
              Emergency Response
            </p>
...

          {
            <div className="mx-4 flex flex-col items-center text-center">
              ...
              <p className="mb-4 text-xl font-bold text-[#2474A3]">
                Free iftars on campus
              </p>
              <p>
                {" "}
                Inshallah we will be giving out free iftars everday Monday -
                Friday in{" "}
                <Link href="#prayerlocations" className="underline">
                  PMC
                </Link>
                . Registration is mandatory click the button below for more info
              </p>
              <Link
                href="https://docs.google.com/forms/d/1wa1rcim8VSwiqq6heLcV7zoEFh2MDMiAgD5xcdhfPBk"
                target="_blank"
              >
                <button className=" my-4 rounded-lg bg-[#203B5D] px-8 py-2 font-bold text-white">
                  Register here
          ...
          <div className="mx-4 flex flex-col items-center text-center">
            ...
            <p className="mb-4">
              A prayer table for all your needs print your own or download{" "}
              <Link
                href="/ramadan_schdules.pdf"
                target="_blank"
                className="underline"
              >
                here
            ...
            <div className="rounded-lg bg-[#203B5D] p-4">
              <Image
                src="https://firebasestorage.googleapis.com/v0/b/wlumsa-web.appspot.com/o/images%2FRamadan%20Schedule%20MSA%20(1).png?alt=media&token=754c7c81-7f98-4ee5-b8bf-d03da80d6391"
                width={966}
                height={1250}
                alt="prayer table"
              />
          ...
          <div className="mx-4 flex flex-col items-center">
            ...
            <div className="rounded-lg bg-[#203B5D] p-4">
              <Image
                src="https://firebasestorage.googleapis.com/v0/b/wlumsa-web.appspot.com/o/images%2FRamadan%20Checklist%20(US%20Letter%20(Landscape)).png?alt=media&token=89990175-ccc8-45e4-8f5c-f2dcacab24be"
                width={1250}
                height={966}
            ...
            <Link href="/ramadan_schdules.pdf" target="_blank">
              <button
                id="download"
                className="my-4 rounded-lg bg-[#203B5D] px-8 py-2 font-bold text-white"
              >
                Download
              </button>
            </Link>
